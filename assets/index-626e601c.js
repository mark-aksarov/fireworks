...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:un,depthTest:!1,depthWrite:!1})}function Ra(){return new Lt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:gs(),fragmentShader:`
		...
		`,blending:un,depthTest:!1,depthWrite:!1})}function Ca(){return new Lt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:gs(),fragmentShader:`
...
`)}function Ud(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Qn(i){return i!==""}function Ba(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function za(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Id=/^[ \t]*#include +<([\w\d./]+)>/gm;function ls(i){return i.replace(Id,Fd)}const Nd=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Fd(i,e){let t=Fe[e];if(t===void 0){const n=Nd.get(e);if(n!==void 0)t=Fe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return ls(t)}const Od=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ga(i){return i.replace(Od,Bd)}function Bd(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Ha(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function zd(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===io?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Qo?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Jt&&(e="SHADOWMAP_TYPE_VSM"),e}function Gd(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ii:case ri:e="ENVMAP_TYPE_CUBE";break;case cr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Hd(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ri:e="ENVMAP_MODE_REFRACTION";break}return e}function Vd(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case ro:e="ENVMAP_BLENDING_MULTIPLY";break;case yl:e="ENVMAP_BLENDING_MIX";break;case Tl:e="ENVMAP_BLENDING_ADD";break}return e}function kd(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Wd(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=zd(t),c=Gd(t),u=Hd(t),f=Vd(t),d=kd(t),p=t.isWebGL2?"":Pd(t),g=Ld(t),v=Dd(s),m=r.createProgram();let h,y,E=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Qn).join(`
`),y=[p,Ha(t),"#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,v,t.useFog&&t.fog?"#define USE_FOG":"",t.useFog&&t.fogExp2?"#define FOG_EXP2":"",t.map?"#define USE_MAP":"",t.matcap?"#define USE_MATCAP":"",t.envMap?"#define USE_ENVMAP":"",t.envMap?"#define "+c:"",t.envMap?"#define "+u:"",t.envMap?"#define "+f:"",d?"#define CUBEUV_TEXEL_WIDTH "+d.texelWidth:"",d?"#define CUBEUV_TEXEL_HEIGHT "+d.texelHeight:"",d?"#define CUBEUV_MAX_MIP "+d.maxMip+".0":"",t.lightMap?"#define USE_LIGHTMAP":"",t.aoMap?"#define USE_AOMAP":"",t.bumpMap?"#define USE_BUMPMAP":"",t.normalMap?"#define USE_NORMALMAP":"",t.normalMapObjectSpace?"#define USE_NORMALMAP_OBJECTSPACE":"",t.normalMapTangentSpace?"#define USE_NORMALMAP_TANGENTSPACE":"",t.emissiveMap?"#define USE_EMISSIVEMAP":"",t.anisotropy?"#define USE_ANISOTROPY":"",t.anisotropyMap?"#define USE_ANISOTROPYMAP":"",t.clearcoat?"#define USE_CLEARCOAT":"",t.clearcoatMap?"#define USE_CLEARCOATMAP":"",t.clearcoatRoughnessMap?"#define USE_CLEARCOAT_ROUGHNESSMAP":"",t.clearcoatNormalMap?"#define USE_CLEARCOAT_NORMALMAP":"",t.iridescence?"#define USE_IRIDESCENCE":"",t.iridescenceMap?"#define USE_IRIDESCENCEMAP":"",t.iridescenceThicknessMap?"#define USE_IRIDESCENCE_THICKNESSMAP":"",t.specularMap?"#define USE_SPECULARMAP":"",t.specularColorMap?"#define USE_SPECULAR_COLORMAP":"",t.specularIntensityMap?"#define USE_SPECULAR_INTENSITYMAP":"",t.roughnessMap?"#define USE_ROUGHNESSMAP":"",t.metalnessMap?"#define USE_METALNESSMAP":"",t.alphaMap?"#define USE_ALPHAMAP":"",t.alphaTest?"#define USE_ALPHATEST":"",t.alphaHash?"#define USE_ALPHAHASH":"",t.sheen?"#define USE_SHEEN":"",t.sheenColorMap?"#define USE_SHEEN_COLORMAP":"",t.sheenRoughnessMap?"#define USE_SHEEN_ROUGHNESSMAP":"",t.transmission?"#define USE_TRANSMISSION":"",t.transmissionMap?"#define USE_TRANSMISSIONMAP":"",t.thicknessMap?"#define USE_THICKNESSMAP":"",t.vertexTangents&&t.flatShading===!1?"#define USE_TANGENT":"",t.vertexColors||t.instancingColor?"#define USE_COLOR":"",t.vertexAlphas?"#define USE_COLOR_ALPHA":"",t.vertexUv1s?"#define USE_UV1":"",t.vertexUv2s?"#define USE_UV2":"",t.vertexUv3s?"#define USE_UV3":"",t.pointsUvs?"#define USE_POINTS_UV":"",t.gradientMap?"#define USE_GRADIENTMAP":"",t.flatShading?"#define FLAT_SHADED":"",t.doubleSided?"#define DOUBLE_SIDED":"",t.flipSided?"#define FLIP_SIDED":"",t.shadowMapEnabled?"#define USE_SHADOWMAP":"",t.shadowMapEnabled?"#define "+l:"",t.premultipliedAlpha?"#define PREMULTIPLIED_ALPHA":"",t.numLightProbes>0?"#define USE_LIGHT_PROBES":"",t.useLegacyLights?"#define LEGACY_LIGHTS":"",t.decodeVideoTexture?"#define DECODE_VIDEO_TEXTURE":"",t.logarithmicDepthBuffer?"#define USE_LOGDEPTHBUF":"",t.logarithmicDepthBuffer&&t.rendererExtensionFragDepth?"#define USE_LOGDEPTHBUF_EXT":"","uniform mat4 viewMatrix;","uniform vec3 cameraPosition;","uniform bool isOrthographic;",t.toneMapping!==hn?"#define TONE_MAPPING":"",t.toneMapping!==hn?Fe.tonemapping_pars_fragment:"",t.toneMapping!==hn?Cd("toneMapping",t.toneMapping):"",t.dithering?"#define DITHERING":"",t.opaque?"#define OPAQUE":"",Fe.colorspace_pars_fragment,Rd("linearToOutputTexel",t.outputColorSpace),t.useDepthPacking?"#define DEPTH_PACKING "+t.depthPacking:"",`
`].filter(Qn).join(`
`)),o=ls(o),o=Ba(o,t),o=za(o,t),a=ls(a),a=Ba(a,t),a=za(a,t),o=Ga(o),a=Ga(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
}`;const Ja={type:"change"},jr={type:"start"},Qa={type:"end"},$i=new ps,eo=new on,Ap=Math.cos(70*Tn.DEG2RAD);class bp extends Dn{constructor(e,t){super(),this.object=e,this.domElement=t,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new L,this.cursor=new L,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Un.ROTATE,MIDDLE:Un.DOLLY,RIGHT:Un.PAN},this.touches={ONE:In.ROTATE,TWO:In.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return a.phi},this.getAzimuthalAngle=function(){return a.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(A){A.addEventListener("keydown",Q),this._domElementKeyEvents=A},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",Q),this._domElementKeyEvents=null},this.saveState=function(){n.target0.copy(n.target),n.position0.copy(n.object.position),n.zoom0=n.object.zoom},this.reset=function(){n.target.copy(n.target0),n.object.position.copy(n.position0),n.object.zoom=n.zoom0,n.object.updateProjectionMatrix(),n.dispatchEvent(Ja),n.update(),s=r.NONE},this.update=function(){const A=new L,K=new Pn().setFromUnitVectors(e.up,new L(0,1,0)),le=K.clone().invert(),te=new L,ve=new Pn,ze=new L,We=2*Math.PI;return function(ae=null){const C=n.object.position;A.copy(C).sub(n.target),A.applyQuaternion(K),a.setFromVector3(A),n.autoRotate&&s===r.NONE&&H(S(ae)),n.enableDamping?(a.theta+=l.theta*n.dampingFactor,a.phi+=l.phi*n.dampingFactor):(a.theta+=l.theta,a.phi+=l.phi);let ie=n.minAzimuthAngle,re=n.maxAzimuthAngle;isFinite(ie)&&isFinite(re)&&(ie<-Math.PI?ie+=We:ie>Math.PI&&(ie-=We),re<-Math.PI?re+=We:re>Math.PI&&(re-=We),ie<=re?a.theta=Math.max(ie,Math.min(re,a.theta)):a.theta=a.theta>(ie+re)/2?Math.max(ie,a.theta):Math.min(re,a.theta)),a.phi=Math.max(n.minPolarAngle,Math.min(n.maxPolarAngle,a.phi)),a.makeSafe(),n.enableDamping===!0?n.target.addScaledVector(u,n.dampingFactor):n.target.add(u),n.target.sub(n.cursor),n.target.clampLength(n.minTargetRadius,n.maxTargetRadius),n.target.add(n.cursor),n.zoomToCursor&&R||n.object.isOrthographicCamera?a.radius=X(a.radius):a.radius=X(a.radius*c),A.setFromSpherical(a),A.applyQuaternion(le),C.copy(n.target).add(A),n.object.lookAt(n.target),n.enableDamping===!0?(l.theta*=1-n.dampingFactor,l.phi*=1-n.dampingFactor,u.multiplyScalar(1-n.dampingFactor)):(l.set(0,0,0),u.set(0,0,0));let ye=!1;if(n.zoomToCursor&&R){let Me=null;if(n.object.isPerspectiveCamera){const qe=A.length();Me=X(qe*c);const Ye=qe-Me;n.object.position.addScaledVector(b,Ye),n.object.updateMatrixWorld()}else if(n.object.isOrthographicCamera){const qe=new L(D.x,D.y,0);qe.unproject(n.object),n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom/c)),n.object.updateProjectionMatrix(),ye=!0;const Ye=new L(D.x,D.y,0);Ye.unproject(n.object),n.object.position.sub(Ye).add(qe),n.object.updateMatrixWorld(),Me=A.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),n.zoomToCursor=!1;Me!==null&&(this.screenSpacePanning?n.target.set(0,0,-1).transformDirection(n.object.matrix).multiplyScalar(Me).add(n.object.position):($i.origin.copy(n.object.position),$i.direction.set(0,0,-1).transformDirection(n.object.matrix),Math.abs(n.object.up.dot($i.direction))<Ap?e.lookAt(n.target):(eo.setFromNormalAndCoplanarPoint(n.object.up,n.target),$i.intersectPlane(eo,n.target))))}else n.object.isOrthographicCamera&&(n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom/c)),n.object.updateProjectionMatrix(),ye=!0);return c=1,R=!1,ye||te.distanceToSquared(n.object.position)>o||8*(1-ve.dot(n.object.quaternion))>o||ze.distanceToSquared(n.target)>0?(n.dispatchEvent(Ja),te.copy(n.object.position),ve.copy(n.object.quaternion),ze.copy(n.target),!0):!1}}(),this.dispose=function(){n.domElement.removeEventListener("contextmenu",pe),n.domElement.removeEventListener("pointerdown",De),n.domElement.removeEventListener("pointercancel",_),n.domElement.removeEventListener("wheel",J),n.domElement.removeEventListener("pointermove",M),n.domElement.removeEventListener("pointerup",_),n._domElementKeyEvents!==null&&(n._domElementKeyEvents.removeEventListener("keydown",Q),n._domElementKeyEvents=null)};const n=this,r={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let s=r.NONE;const o=1e-6,a=new Ka,l=new Ka;let c=1;const u=new L,f=new ce,d=new ce,p=new ce,g=new ce,v=new ce,m=new ce,h=new ce,y=new ce,E=new ce,b=new L,D=new ce;let R=!1;const w=[],j={};function S(A){return A!==null?2*Math.PI/60*n.autoRotateSpeed*A:2*Math.PI/60/60*n.autoRotateSpeed}function T(A){const K=Math.abs(A)/(100*(window.devicePixelRatio|0));return Math.pow(.95,n.zoomSpeed*K)}function H(A){l.theta-=A}function W(A){l.phi-=A}const oe=function(){const A=new L;return function(le,te){A.setFromMatrixColumn(te,0),A.multiplyScalar(-le),u.add(A)}}(),P=function(){const A=new L;return function(le,te){n.screenSpacePanning===!0?A.setFromMatrixColumn(te,1):(A.setFromMatrixColumn(te,0),A.crossVectors(n.object.up,A)),A.multiplyScalar(le),u.add(A)}}(),O=function(){const A=new L;return function(le,te){const ve=n.domElement;if(n.object.isPerspectiveCamera){const ze=n.object.position;A.copy(ze).sub(n.target);let We=A.length();We*=Math.tan(n.object.fov/2*Math.PI/180),oe(2*le*We/ve.clientHeight,n.object.matrix),P(2*te*We/ve.clientHeight,n.object.matrix)}else n.object.isOrthographicCamera?(oe(le*(n.object.right-n.object.left)/n.object.zoom/ve.clientWidth,n.object.matrix),P(te*(n.object.top-n.object.bottom)/n.object.zoom/ve.clientHeight,n.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),n.enablePan=!1)}}();function V(A){n.object.isPerspectiveCamera||n.object.isOrthographicCamera?c/=A:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),n.enableZoom=!1)}function q(A){n.object.isPerspectiveCamera||n.object.isOrthographicCamera?c*=A:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),n.enableZoom=!1)}function k(A,K){if(!n.zoomToCursor)return;R=!0;const le=n.domElement.getBoundingClientRect(),te=A-le.left,ve=K-le.top,ze=le.width,We=le.height;D.x=te/ze*2-1,D.y=-(ve/We)*2+1,b.set(D.x,D.y,1).unproject(n.object).sub(n.object.position).normalize()}function X(A){return Math.max(n.minDistance,Math.min(n.maxDistance,A))}function Y(A){f.set(A.clientX,A.clientY)}function ne(A){k(A.clientX,A.clientX),h.set(A.clientX,A.clientY)}function se(A){g.set(A.clientX,A.clientY)}function G(A){d.set(A.clientX,A.clientY),p.subVectors(d,f).multiplyScalar(n.rotateSpeed);const K=n.domElement;H(2*Math.PI*p.x/K.clientHeight),W(2*Math.PI*p.y/K.clientHeight),f.copy(d),n.update()}function Z(A){y.set(A.clientX,A.clientY),E.subVectors(y,h),E.y>0?V(T(E.y)):E.y<0&&q(T(E.y)),h.copy(y),n.update()}function fe(A){v.set(A.clientX,A.clientY),m.subVectors(v,g).multiplyScalar(n.panSpeed),O(m.x,m.y),g.copy(v),n.update()}function xe(A){k(A.clientX,A.clientY),A.deltaY<0?q(T(A.deltaY)):A.deltaY>0&&V(T(A.deltaY)),n.update()}function _e(A){let K=!1;switch(A.code){case n.keys.UP:A.ctrlKey||A.metaKey||A.shiftKey?W(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):O(0,n.keyPanSpeed),K=!0;break;case n.keys.BOTTOM:A.ctrlKey||A.metaKey||A.shiftKey?W(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):O(0,-n.keyPanSpeed),K=!0;break;case n.keys.LEFT:A.ctrlKey||A.metaKey||A.shiftKey?H(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):O(n.keyPanSpeed,0),K=!0;break;case n.keys.RIGHT:A.ctrlKey||A.metaKey||A.shiftKey?H(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):O(-n.keyPanSpeed,0),K=!0;break}K&&(A.preventDefault(),n.update())}function Ce(A){if(w.length===1)f.set(A.pageX,A.pageY);else{const K=ke(A),le=.5*(A.pageX+K.x),te=.5*(A.pageY+K.y);f.set(le,te)}}function Le(A){if(w.length===1)g.set(A.pageX,A.pageY);else{const K=ke(A),le=.5*(A.pageX+K.x),te=.5*(A.pageY+K.y);g.set(le,te)}}function Te(A){const K=ke(A),le=A.pageX-K.x,te=A.pageY-K.y,ve=Math.sqrt(le*le+te*te);h.set(0,ve)}function Ve(A){n.enableZoom&&Te(A),n.enablePan&&Le(A)}function I(A){n.enableZoom&&Te(A),n.enableRotate&&Ce(A)}function at(A){if(w.length==1)d.set(A.pageX,A.pageY);else{const le=ke(A),te=.5*(A.pageX+le.x),ve=.5*(A.pageY+le.y);d.set(te,ve)}p.subVectors(d,f).multiplyScalar(n.rotateSpeed);const K=n.domElement;H(2*Math.PI*p.x/K.clientHeight),W(2*Math.PI*p.y/K.clientHeight),f.copy(d)}function Ee(A){if(w.length===1)v.set(A.pageX,A.pageY);else{const K=ke(A),le=.5*(A.pageX+K.x),te=.5*(A.pageY+K.y);v.set(le,te)}m.subVectors(v,g).multiplyScalar(n.panSpeed),O(m.x,m.y),g.copy(v)}function we(A){const K=ke(A),le=A.pageX-K.x,te=A.pageY-K.y,ve=Math.sqrt(le*le+te*te);y.set(0,ve),E.set(0,Math.pow(y.y/h.y,n.zoomSpeed)),V(E.y),h.copy(y);const ze=(A.pageX+K.x)*.5,We=(A.pageY+K.y)*.5;k(ze,We)}function me(A){n.enableZoom&&we(A),n.enablePan&&Ee(A)}function Ze(A){n.enableZoom&&we(A),n.enableRotate&&at(A)}function De(A){n.enabled!==!1&&(w.length===0&&(n.domElement.setPointerCapture(A.pointerId),n.domElement.addEventListener("pointermove",M),n.domElement.addEventListener("pointerup",_)),Ae(A),A.pointerType==="touch"?ge(A):N(A))}function M(A){n.enabled!==!1&&(A.pointerType==="touch"?he(A):ee(A))}function _(A){Ie(A),w.length===0&&(n.domElement.releasePointerCapture(A.pointerId),n.domElement.removeEventListener("pointermove",M),n.domElement.removeEventListener("pointerup",_)),n.dispatchEvent(Qa),s=r.NONE}function N(A){let K;switch(A.button){case 0:K=n.mouseButtons.LEFT;break;case 1:K=n.mouseButtons.MIDDLE;break;case 2:K=n.mouseButtons.RIGHT;break;default:K=-1}switch(K){case Un.DOLLY:if(n.enableZoom===!1)return;ne(A),s=r.DOLLY;break;case Un.ROTATE:if(A.ctrlKey||A.metaKey||A.shiftKey){if(n.enablePan===!1)return;se(A),s=r.PAN}else{if(n.enableRotate===!1)return;Y(A),s=r.ROTATE}break;case Un.PAN:if(A.ctrlKey||A.metaKey||A.shiftKey){if(n.enableRotate===!1)return;Y(A),s=r.ROTATE}else{if(n.enablePan===!1)return;se(A),s=r.PAN}break;default:s=r.NONE}s!==r.NONE&&n.dispatchEvent(jr)}function ee(A){switch(s){case r.ROTATE:if(n.enableRotate===!1)return;G(A);break;case r.DOLLY:if(n.enableZoom===!1)return;Z(A);break;case r.PAN:if(n.enablePan===!1)return;fe(A);break}}function J(A){n.enabled===!1||n.enableZoom===!1||s!==r.NONE||(A.preventDefault(),n.dispatchEvent(jr),xe(A),n.dispatchEvent(Qa))}function Q(A){n.enabled===!1||n.enablePan===!1||_e(A)}function ge(A){switch($(A),w.length){case 1:switch(n.touches.ONE){case In.ROTATE:if(n.enableRotate===!1)return;Ce(A),s=r.TOUCH_ROTATE;break;case In.PAN:if(n.enablePan===!1)return;Le(A),s=r.TOUCH_PAN;break;default:s=r.NONE}break;case 2:switch(n.touches.TWO){case In.DOLLY_PAN:if(n.enableZoom===!1&&n.enablePan===!1)return;Ve(A),s=r.TOUCH_DOLLY_PAN;break;case In.DOLLY_ROTATE:if(n.enableZoom===!1&&n.enableRotate===!1)return;I(A),s=r.TOUCH_DOLLY_ROTATE;break;default:s=r.NONE}break;default:s=r.NONE}s!==r.NONE&&n.dispatchEvent(jr)}function he(A){switch($(A),s){case r.TOUCH_ROTATE:if(n.enableRotate===!1)return;at(A),n.update();break;case r.TOUCH_PAN:if(n.enablePan===!1)return;Ee(A),n.update();break;case r.TOUCH_DOLLY_PAN:if(n.enableZoom===!1&&n.enablePan===!1)return;me(A),n.update();break;case r.TOUCH_DOLLY_ROTATE:if(n.enableZoom===!1&&n.enableRotate===!1)return;Ze(A),n.update();break;default:s=r.NONE}}function pe(A){n.enabled!==!1&&A.preventDefault()}function Ae(A){w.push(A.pointerId)}function Ie(A){delete j[A.pointerId];for(let K=0;K<w.length;K++)if(w[K]==A.pointerId){w.splice(K,1);return}}function $(A){let K=j[A.pointerId];K===void 0&&(K=new ce,j[A.pointerId]=K),K.set(A.pageX,A.pageY)}function ke(A){const K=A.pointerId===w[0]?w[1]:w[0];return j[K]}n.domElement.addEventListener("contextmenu",pe),n.domElement.addEventListener("pointerdown",De),n.domElement.addEventListener("pointercancel",_),n.domElement.addEventListener("wheel",J,{passive:!1}),this.update()}}const zo=document.querySelector("canvas.webgl"),Si=new vp,pn=new Ct(40,window.innerWidth/window.innerHeight,.1,100);pn.position.set(0,0,15);Si.add(pn);const Go=new bp(pn,zo);Go.enableDamping=!0;const Ln=new Oo({antialias:!0,canvas:zo});Ln.setPixelRatio(Math.min(window.devicePixelRatio,2));Ln.setSize(window.innerWidth,window.innerHeight);Ln.toneMapping=so;Ln.toneMappingExposure=1;const wp=new Bo([new ce(0,0),new ce(.047439,.008781),new ce(.083663,.036272),new ce(.105215,.080331),new ce(.113577,.124871),new ce(.115893,.169723),new ce(.114094,.226568),new ce(.109559,.280991),new ce(.10237,.34497),new ce(.092311,.42474),new ce(.080957,.514696),new ce(.07082,.594478),new ce(.064582,.662809),new ce(.054219,.788387),new ce(.045788,.890215),new ce(.035777,1.016548),new ce(.017421,1.161712),new ce(0,1.188697)]),Rp=new Bo([new ce(0,.05249219),new ce(.02353037,.05557644),new ce(.04733661,.07088265),new ce(.06289341,.0987086),new ce(.0700641,.130316),new ce(.07257684,.1615261),new ce(.07244543,.19605456),new ce(.07011111,.23376948),new ce(.06502574,.28320913),new ce(.05755539,.3417307),new ce(.04716476,.4177944),new ce(.03611469,.50519714),new ce(.02592416,.59628838),new ce(.01742113,.67885639),new ce(.007927,.763),new ce(0,.77643018)]),Ho=100,Kr=wp.getPoints(Ho),Cp=Rp.getPoints(Ho),to=[new Xe(13713126),new Xe(255),new Xe(16724838),new Xe(3394815),new Xe(16777215)],Pe={fireworksDuration:1.4,fadeInDuration:.2,tailGrowthDuration:.2,tailGrowthPower:2.5,fadeOutBeforeEnd:.8,fadeOutDuration:.6,maxDropDelay:0,dropCount:14,sliceCount:15,minRadius:2.7,maxRadius:3.3,targetOffset:.35,particleCount:1400,particleSystemLength:1.5,tailThickness:.15,minTailThickness:.05,particleSize:70,outerGlowStrength:6,innerGlowStrength:4,outerOpacity:.3,innerOpacity:1,outerStartTailOpacity:.9,innerStartTailOpacity:.5,cameraFov:40},_s=new Ep;let vs=0;const pr=[];let An=new ei;Si.add(An);function Vo(){return to[Math.floor(Math.random()*to.length)]}function ko(){const i=Tn.lerp(Pe.minRadius,Pe.maxRadius,Math.random());return new L(i,(Math.random()-.5)*Pe.targetOffset,(Math.random()-.5)*Pe.targetOffset)}function no(i){return 1-Math.pow(1-i,3)}function Pp(i){const e=Math.max(...Kr.map(n=>n.y))-Math.min(...Kr.map(n=>n.y)),t=new ut;{const n=new lr(Kr,100),r=new Lt({side:Ft,depthWrite:!1,blending:pi,vertexShader:Za,fragmentShader:$a,uniforms:{uGlowColor:{value:i},uGlowStrength:{value:Pe.outerGlowStrength},uStartTailOpacity:{value:Pe.outerStartTailOpacity},uOpacity:{value:0},uDropLength:{value:e},uTailGrowth:{value:0}}});r.userData.originalOpacity=Pe.outerOpacity;const s=new kt(n,r);t.add(s)}{const n=new lr(Cp,100),r=new Lt({side:Ft,depthWrite:!1,blending:pi,vertexShader:Za,fragmentShader:$a,uniforms:{uGlowColor:{value:i},uGlowStrength:{value:Pe.innerGlowStrength},uStartTailOpacity:{value:Pe.innerStartTailOpacity},uOpacity:{value:0},uDropLength:{value:e},uTailGrowth:{value:0}}});r.userData.originalOpacity=Pe.innerOpacity;const s=new kt(n,r);t.add(s)}{const n=Pe.particleCount,r=new Float32Array(n*3);for(let l=0;l<n;l++){const c=Tn.inverseLerp(0,n,l),u=(1-c)*(Pe.tailThickness-Pe.minTailThickness)+Pe.minTailThickness,f=Math.random()*Math.PI*2,d=(Math.random()-.5)*u*Math.cos(f),p=(Math.random()-.5)*u*Math.sin(f),g=Math.pow(c,10)*Pe.particleSystemLength,v=l*3;r[v]=d,r[v+1]=g+.1,r[v+2]=p}const s=new Xt;s.setAttribute("position",new zt(r,3));const o=new Lt({depthWrite:!1,blending:pi,vertexShader:yp,fragmentShader:Tp,uniforms:{uTime:{value:0},uSize:{value:Pe.particleSize},uGlowColor:{value:i},uOpacity:{value:0},uParticleSystemLength:{value:Pe.particleSystemLength},uTailGrowth:{value:0}}});o.userData.originalOpacity=1;const a=new Mp(s,o);t.add(a)}return t}function Wo(){const i=new ut;for(let e=1;e<Pe.dropCount;e++){const t=Vo(),n=Pp(t);n.rotateZ(Math.PI/2),n.position.set(0,0,0);const r=ko(),s=Math.random()*Pe.maxDropDelay;n.userData.firework={start:new L(0,0,0),target:r,delay:s};const o=new ut;o.add(n),o.rotateZ((e-Math.random()/3)*Math.PI/Pe.dropCount),i.add(o)}for(let e=0;e<=Pe.sliceCount;e++){const t=new ut,n=i.clone(!0);t.add(n),t.rotateX((e-Math.random()/3)*Math.PI*2/Pe.sliceCount),An.add(t)}An.traverse(e=>{var t;(t=e.userData)!=null&&t.firework&&pr.push(e)})}function Lp(){pr.length=0,An.traverse(i=>{var e;(i.isMesh||i.isPoints)&&((e=i.geometry)==null||e.dispose(),i.material&&(Array.isArray(i.material)?i.material.forEach(t=>t.dispose()):i.material.dispose()))}),Si.remove(An),An=new ei,Si.add(An)}function Dp(i){const e=i.userData.firework;e.target=ko(),e.start=new L(0,0,0),e.delay=Math.random()*Pe.maxDropDelay,i.position.set(0,0,0);const t=Vo();i.traverse(n=>{if(n.material instanceof Lt){const r=n.material.uniforms;r!=null&&r.uGlowColor&&(r.uGlowColor.value=t),r!=null&&r.uTailGrowth&&(r.uTailGrowth.value=0),r!=null&&r.uTime&&(r.uTime.value=0),r!=null&&r.uOpacity&&(r.uOpacity.value=0)}})}function xs(){vs=_s.getElapsedTime();for(const i of pr)Dp(i)}function Up(){Lp(),Wo(),xs()}const Zr=document.querySelector(".controls-panel"),$r=document.querySelector(".controls-toggle");$r==null||$r.addEventListener("click",()=>{Zr==null||Zr.classList.toggle("is-collapsed")});function Gt(i,e,t=n=>Number(n).toFixed(2)){const n=document.querySelector(`[data-setting="${i}"]`),r=document.querySelector(`[data-value="${i}"]`);n&&(n.value=Pe[i],r&&(r.textContent=t(n.value)),n.addEventListener("input",()=>{Pe[i]=Number(n.value),r&&(r.textContent=t(n.value))}))}Gt("fireworksDuration",null,i=>`${Number(i).toFixed(2)}s`);Gt("fadeInDuration",null,i=>`${Number(i).toFixed(2)}s`);Gt("tailGrowthDuration",null,i=>`${Number(i).toFixed(2)}s`);Gt("tailGrowthPower",null,i=>Number(i).toFixed(2));Gt("fadeOutBeforeEnd",null,i=>`${Number(i).toFixed(2)}s`);Gt("fadeOutDuration",null,i=>`${Number(i).toFixed(2)}s`);Gt("maxDropDelay",null,i=>`${Number(i).toFixed(2)}s`);Gt("minRadius",null,i=>Number(i).toFixed(2));Gt("maxRadius",null,i=>Number(i).toFixed(2));Gt("targetOffset",null,i=>Number(i).toFixed(2));Gt("particleSize",null,i=>Number(i).toFixed(0));const Jr=document.querySelector(".restart-firework");Jr==null||Jr.addEventListener("click",xs);const Qr=document.querySelector(".apply-geometry");Qr==null||Qr.addEventListener("click",Up);const Ji=document.querySelector('[data-setting="cameraFov"]'),Qi=document.querySelector('[data-value="cameraFov"]');Ji&&(Ji.value=Pe.cameraFov,Qi&&(Qi.textContent=`${Pe.cameraFov}°`),Ji.addEventListener("input",()=>{Pe.cameraFov=Number(Ji.value),pn.fov=Pe.cameraFov,pn.updateProjectionMatrix(),Qi&&(Qi.textContent=`${Pe.cameraFov}°`)}));window.addEventListener("resize",()=>{pn.aspect=window.innerWidth/window.innerHeight,pn.updateProjectionMatrix(),Ln.setSize(window.innerWidth,window.innerHeight),Ln.setPixelRatio(Math.min(window.devicePixelRatio,2))});Wo();vs=_s.getElapsedTime();const Xo=()=>{const i=_s.getElapsedTime(),e=i-vs,t=Math.max(0,Pe.fireworksDuration-Pe.fadeOutBeforeEnd),n=Math.min(Pe.fadeOutDuration,Pe.fireworksDuration-t);for(const r of pr){const s=r.userData.firework;let o=e-s.delay;o<0&&(o=0);const a=Tn.clamp(o/Pe.fireworksDuration,0,1),l=no(a);r.position.lerpVectors(s.start,s.target,l);const c=Tn.clamp(o/Pe.tailGrowthDuration,0,1),u=Math.pow(c,Pe.tailGrowthPower);let f=1;if(Pe.fadeInDuration>0&&o<Pe.fadeInDuration){const d=Tn.clamp(o/Pe.fadeInDuration,0,1);f=no(d)}if(o>t&&n>0){const d=Tn.clamp((o-t)/n,0,1);f*=1-d}o>=Pe.fireworksDuration&&(f=0),r.traverse(d=>{if(d.material instanceof Lt){const p=d.material.uniforms;if(p!=null&&p.uTailGrowth&&(p.uTailGrowth.value=u),p!=null&&p.uTime&&(p.uTime.value=i),p!=null&&p.uOpacity){const g=d.material.userData.originalOpacity??1;p.uOpacity.value=g*f}p!=null&&p.uSize&&(p.uSize.value=Pe.particleSize),p!=null&&p.uParticleSystemLength&&(p.uParticleSystemLength.value=Pe.particleSystemLength)}})}e>=Pe.fireworksDuration&&xs(),Go.update(),Ln.render(Si,pn),requestAnimationFrame(Xo)};Xo();
//# sourceMappingURL=index-626e601c.js.map
